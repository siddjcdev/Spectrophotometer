...
wri = CWriter(ssd, font, BLUE, BLACK, verbose=True)
...
wri_tiny = CWriter(ssd, tiny_font, RED, BLACK, verbose=False)
...
class BaseScreen(Screen):
    def __init__(self):
        ...
        Label(wri_small_yellow, 40, 20, "Experiment Mode")
        #fwdbutton(wri, 40, 40, BackScreen)
        #CloseButton(wri)
        #Label (wri_small_yellow, 55, 50, "Ready for Experimentation")  
        Label(wri_small_green, 90, 5, "Proceed with Step 1 as displayed")
        Label(wri_small_green, 120, 5, "on the webserver.")
