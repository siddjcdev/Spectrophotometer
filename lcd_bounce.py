...
def test():
    ...
    try:
        ...
        #spi = SPI(0, baudrate=40000000, sck=Pin(18), mosi=Pin(16))
        #display = Display(spi, dc=Pin(4), cs=Pin(16), rst=Pin(17))
        #spi = SPI(0, baudrate=10000000, sck=Pin(18), mosi=Pin(16))
        #display = Display(spi, dc=Pin(20), cs=Pin(22), rst=Pin(19))
